            ...
            <div className='w-full'>
              ...
              <div className='mt-5 flex flex-col items-center'>
                ...
                <form className='w-[50%] mx-auto '>
                  ...
                  <div className='mt-8 '>
                    <button type="button" className='border-[2px] px-2 text-sm font-semibold focus:outline-none   w-full font-Bungee-Shade py-2.5  text-white rounded-xl flex justify-center items-center bg-[#27014d] focus:scale-95 duration-300 ease-in-out transition-all'>Create Account <span className='pl-3'><FaCloudsmith /></span></button>
                  </div>
                </form>
