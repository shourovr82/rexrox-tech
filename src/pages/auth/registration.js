          ...
          <div className='col-span-7 flex justify-center'>
            <div className='w-full'>
              ...
              <div className='mt-3 max-md:mt-10 flex flex-col items-center'>
                <div>
                  <h1 className=' text-2xl lg:text-3xl font-Bungee-Shade text-[#3b2250] font-semibold'>Create Your Free Account</h1>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='lg:w-[50%] mx-auto '>
                  ...
                  <div className='mt-8 '>
                    <button type="submit" className='border-[2px] px-2 text-sm font-semibold focus:outline-none   w-full font-Bungee-Shade py-2.5  text-white rounded-xl flex justify-center items-center bg-[#27014d] focus:scale-95 duration-300 ease-in-out transition-all'>Sign Up <span className='pl-3'><FaCloudsmith /></span></button>
                  </div>
                </form>
