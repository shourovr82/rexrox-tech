              ...
              <div className="h-full px-4 pb-16 sm:px-6 lg:px-24 2xl:px-32 lg:pt-40 lg:pb-14">
                <div className="flex flex-col justify-between flex-1 h-full">
                  <div>
                    ...
                    <button title="" className="inline-flex items-center px-6 py-5 text-base font-semibold text-[#6a03aa] hover:text-white transition-all duration-200 border-[#6a03aa] border  mt-9 hover:bg-[#6a03aa] rounded-md" role="button"> Get started for free </button>
                  </div>
